...
# Abre chrome://extensions, activa el modo desarrollador y carga la carpeta descomprimida.
```
...
`challenge_browser` admite `auto`, `existing` (sin ventana nueva) o `isolated`.
